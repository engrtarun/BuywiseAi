  ...
  return (
    <div className="flex flex-col h-full w-full bg-bg-main relative pt-2">
      ...
      <div className="flex-1 overflow-hidden relative">
        ...
        <div 
          className={`absolute inset-0 flex flex-col p-2 pb-24 overflow-hidden transition-all duration-300 ${
            mode === "mix" ? "opacity-100 z-10 pointer-events-auto scale-100" : "opacity-0 z-0 pointer-events-none scale-95"
          }`}
        >
          {/* Top Half */}
        ...
        <div 
          className={`absolute inset-0 w-full h-full transition-all duration-300 ${
            mode === "canvas" ? "opacity-100 z-10 pointer-events-auto scale-100" : "opacity-0 z-0 pointer-events-none scale-95"
          }`}
        >
